...
import { fetchAllCampusesThunk, deleteCampusThunk } from "../../store/thunks"; // <-- Ensure this import
...
const mapDispatch = (dispatch) => {
  return {
    ...
    deleteCampus: (campusId) => dispatch(deleteCampusThunk(campusId)), // Ensure this is defined
  };
};
